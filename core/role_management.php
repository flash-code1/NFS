              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">View Roles and Permission</li>
                  </ol>
                </div>
                <div class="col-6">
                  <!-- Bookmark Start-->
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>View Roles Details</h5><span>This page help you view all the Roles of Nspire and also as a route for creating.</span>
                    <!-- button to create -->
                    <button onclick="window.open ('create_role.php')" style="float: right;" class="btn btn-pill btn-success btn-air-success btn-success-gradien" type="button">Create Role</button>
                    <!-- end button -->
                  </div>
                  <div class="card-body">
