                ...
                <div class="col-md-6">
                    <div class="card">
                      <div class="blog-box blog-list row">
                        <div class="col-sm-5"><img class="img-fluid sm-50-w" src="../assets/images/route_image/cash2.svg" alt=""></div>
                        <div class="col-sm-7">
                          <div class="blog-details">
                            <div class="blog-date digits"><b>Payment Category</b> Management</div>
                            <br>
                                   <!-- button to create -->
                    <button onclick="window.open ('payment_category.php')" style="float: right;" class="btn btn-pill btn-dark btn-air-dark btn-dark-gradien" type="button">Manage Category</button>
                    <!-- end button -->
                    <br>
                          </div>
                        </div>
                  ...
                  <div class="col-md-6">
                    <div class="card">
                      <div class="blog-box blog-list row">
                        <div class="col-sm-5"><img class="img-fluid sm-50-w" src="../assets/images/route_image/cash.svg" alt=""></div>
                        <div class="col-sm-7">
                          <div class="blog-details">
                            <div class="blog-date digits"> <b>Payment Product</b> Management</div>
                            <br>
                                   <!-- button to create -->
                    <button onclick="window.open ('payment_management.php')" style="float: right;" class="btn btn-pill btn-dark btn-air-dark btn-dark-gradien" type="button">Manage Product</button>
                    <!-- end button -->
                    <br>
                          </div>
                        </div>
