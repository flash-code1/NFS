              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">View Courses</li>
                  </ol>
                </div>
                <div class="col-6">
                  <!-- Bookmark Start-->
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>View Course Details</h5><span>This page help you view all the Courses in Nspire and also as a route for creating.</span>
                    <!-- button to create -->
                    <button onclick="window.open ('create_course.php')" style="float: right;" class="btn btn-pill btn-success btn-air-success btn-success-gradien" type="button">Create Course</button>
                    <!-- end button -->
                  </div>
                  <div class="card-body">
